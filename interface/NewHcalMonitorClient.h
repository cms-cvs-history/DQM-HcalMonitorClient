#ifndef NewHcalMonitorClient_GUARD_H
#define NewHcalMonitorClient_GUARD_H

/*
 * \file NewHcalMonitorClient.h
 * 
...
class NewHcalMonitorClient: public edm::EDAnalyzer
{

public:

  // Constructor
  NewHcalMonitorClient(const edm::ParameterSet & ps);
  
  // Destructor
  virtual ~NewHcalMonitorClient();
