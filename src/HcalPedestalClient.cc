...
void HcalPedestalClient::htmlOutput(int runNo, string htmlDir, string htmlName)
{
  ...
  htmlFile<<"</tr>"<<endl;
  htmlFile<<"<tr align=\"center\"><td> A pedestal is considered problematic if its mean ADC value differs from the nominal mean value (as stored in the database) by more than "<<maxPedMeanDiffADC_<<" ADC counts.<br>";
